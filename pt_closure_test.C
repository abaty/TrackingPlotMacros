...
//eff correction
TH1D * h_gen = new  TH1D("h_gen",";p_{T};N_{evt}",ny,x);
...
nt_particle->Draw("pt>>h_gen","(pt>0.5)");
nt_particle->Draw("pt>>h_gen_select","(trackselect && pt>0.5)");
nt_particle->Draw("pt>>h_gen_matched_select_corr","(1/eff)*(trackselect && pt>0.5)");
...
leg2->AddEntry((TObject*)0,"#hat{p}_{T}>80GeV/cPythia+Hydjet","");
...
TLegend *leg2a = new TLegend(0.5,0.2,0.95,0.4);
...
//****************************************************************************
//fake correction
TH1D * h_reco = new  TH1D("h_reco",";p_{T};N_{evt}",ny,x);
...
nt_track->Draw("pt>>h_reco","(trackselect && pt>0.5)"); 
nt_track->Draw("pt>>h_reco_matched","(trackselect && !trkfake && pt>0.5)"); 
nt_track->Draw("pt>>h_reco_fakecorr","(1-fake)*(trackselect && pt>0.5)"); 
...
//********************************************************************
//full correction
TH1D * h_reco_fakecorr_effcorr = new TH1D("h_reco_fakecorr_effcorr",";p_{T};N_{evt}",ny,x);
TH1D * h_reco_fakecorr_effcorr_unfold = new TH1D("h_reco_fakecorr_effcorr_unfold",";p_{T};N_{evt}",ny,x);
nt_track->Draw("pt>>h_reco_fakecorr_effcorr","((1-fake)/eff)*(trackselect && pt>0.5)"); 
...
TLegend *leg4a = new TLegend(0.5,0.2,0.95,0.4);
...
/*TH1D *h_matched_pt_particle= new TH1D("h_matched_pt_particle","",ny,x);
TH1D *h_matched_pt_trk= new TH1D("h_matched_pt_trk","",ny,x);
