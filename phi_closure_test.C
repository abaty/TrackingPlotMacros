...
//eff correction
TH1D * h_gen = new  TH1D("h_gen",";#phi;N_{evt}",nbins,low,high);
TH1D * h_gen_select = new  TH1D("h_gen_select",";#phi;N_{evt}",nbins,low,high);
TH1D * h_gen_matched_select_corr = new TH1D("h_gen_matched_select_corr",";#phi;N_{evt}",nbins,low,high);

nt_particle->Draw("phi>>h_gen","pt>0.5");
nt_particle->Draw("phi>>h_gen_select","(trackselect&& pt>0.5)");
nt_particle->Draw("phi>>h_gen_matched_select_corr","(1/eff)*(trackselect && pt>0.5)");
...
h_gen->GetYaxis()->SetRangeUser(3000000,30000000);
...
TH1D * h_reco_fakecorr = new TH1D("h_reco_fakecorr",";#phi;N_{evt}",nbins,low,high);
nt_track->Draw("phi>>h_reco","(trackselect && pt>0.5)"); 
nt_track->Draw("phi>>h_reco_matched","(trackselect && !trkfake && pt>0.5)"); 
nt_track->Draw("phi>>h_reco_fakecorr","(1-fake)*(trackselect && pt>0.5)"); 
...
h_reco->GetYaxis()->SetRangeUser(5000000,13000000);
...
hreco_fakeuncorr_rat->SetMaximum(1.1);
...
nt_track->Draw("phi>>h_reco_fakecorr_effcorr","((1-fake)/eff)*(trackselect && pt>0.5)"); 
