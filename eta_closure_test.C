...
//eff correction
TH1D * h_gen = new  TH1D("h_gen",";#eta;N_{evt}",nbins,low,high);
TH1D * h_gen_select = new  TH1D("h_gen_select",";#eta;N_{evt}",nbins,low,high);
TH1D * h_gen_matched_select_corr = new TH1D("h_gen_matched_select_corr",";#eta;N_{evt}",nbins,low,high);

nt_particle->Draw("eta>>h_gen","(pt>0.5)");
nt_particle->Draw("eta>>h_gen_select","(trackselect && pt>0.5)");
nt_particle->Draw("eta>>h_gen_matched_select_corr","(1/eff)*(trackselect && pt>0.5)");
...
h_gen->GetYaxis()->SetRangeUser(2000000,30000000);
...
c2->SaveAs("compare_gen_select_corr_eta.png");
c2->SaveAs("compare_gen_select_corr_eta.pdf");
...
/************************************************************************************/
//fake correction
TH1D * h_reco = new  TH1D("h_reco",";#eta;N_{evt}",nbins,low,high);
TH1D * h_reco_matched = new  TH1D("h_reco_matched",";#eta;N_{evt}",nbins,low,high);
TH1D * h_reco_fakecorr = new TH1D("h_reco_fakecorr",";#eta;N_{evt}",nbins,low,high);
nt_track->Draw("eta>>h_reco","(trackselect && pt>0.5)"); 
nt_track->Draw("eta>>h_reco_matched","(trackselect && !trkfake && pt>0.5)"); 
nt_track->Draw("eta>>h_reco_fakecorr","(1-fake)*(trackselect && pt>0.5)"); 
...
TLegend *leg3 = new TLegend(0.6,0.65,0.95,0.95);
...
h_reco->GetYaxis()->SetRangeUser(4000000,13000000);
...
hreco_fakeuncorr_rat->SetMaximum(1.25);
...
TLegend *leg3a = new TLegend(0.7,0.75,0.95,0.95);
...
c3->SaveAs("compare_reco_fake_corr_eta.png");
c3->SaveAs("compare_reco_fake_corr_eta.pdf");
...
/*****************************************************************************/
//full correction
TH1D * h_reco_fakecorr_effcorr = new TH1D("h_reco_fakecorr_effcorr",";#eta;N_{evt}",nbins,low,high);
TH1D * h_reco_fakecorr_effcorr_unfold = new TH1D("h_reco_fakecorr_effcorr_unfold",";#eta;N_{evt}",nbins,low,high);
nt_track->Draw("eta>>h_reco_fakecorr_effcorr","((1-fake)/eff)*(trackselect && pt>0.5)"); 

h_reco_fakecorr_effcorr->SetMarkerColor(kRed);
h_reco_fakecorr_effcorr->SetLineColor(kRed);
TLegend *leg4 = new TLegend(0.6,0.65,0.95,0.95);
...
c4->SaveAs("compare_select_fullcorr_eta.png");
c4->SaveAs("compare_select_fullcorr_eta.pdf");
