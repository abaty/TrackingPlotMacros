...
//eff correction
TH1D * h_gen = new  TH1D("h_gen",";rmin;N_{evt}",nbins,low,high);
TH1D * h_gen_select = new  TH1D("h_gen_select",";rmin;N_{evt}",nbins,low,high);
TH1D * h_gen_matched_select_corr = new TH1D("h_gen_matched_select_corr",";rmin;N_{evt}",nbins,low,high);

nt_particle->Draw("rmin>>h_gen","pt>0.5");
nt_particle->Draw("rmin>>h_gen_select","(trackselect&& pt>0.5)");
nt_particle->Draw("rmin>>h_gen_matched_select_corr","(1/eff)*(trackselect && pt>0.5)");
...
h_gen->GetXaxis()->SetTitleOffset(2.5);
...
hgen_uncorr_rat->GetXaxis()->SetTitleOffset(2.5);
hgen_corr_rat->Draw("same");

TLegend *leg2a = new TLegend(0.2,0.5,0.55,0.7);
...
hgen_corr_rat->GetXaxis()->SetTitleOffset(2.5);
TLine * l = new TLine(0,1,5,1);
l->Draw("same");


c2->SaveAs("compare_gen_select_corr_rmin.png");
c2->SaveAs("compare_gen_select_corr_rmin.pdf");
...
//******************************************************************************
//fake correction
TH1D * h_reco = new  TH1D("h_reco",";rmin;N_{evt}",nbins,low,high);
TH1D * h_reco_matched = new  TH1D("h_reco_matched",";rmin;N_{evt}",nbins,low,high);
TH1D * h_reco_fakecorr = new TH1D("h_reco_fakecorr",";rmin;N_{evt}",nbins,low,high);
nt_track->Draw("rmin>>h_reco","(trackselect  && pt>0.5)"); 
nt_track->Draw("rmin>>h_reco_matched","(trackselect && !trkfake && pt>0.5)"); 
nt_track->Draw("rmin>>h_reco_fakecorr","(1-fake)*(trackselect && pt>0.5)"); 
...
//c3->cd(1)->SetLogx();
c3->cd(1)->SetLogy();
h_reco->Draw();h_reco->GetYaxis()->SetLabelSize(18);
...
h_reco->GetXaxis()->SetTitleOffset(2.5);
...
hreco_fakeuncorr_rat->GetXaxis()->SetTitleOffset(2.5);
...
hreco_fakecorr_rat->GetXaxis()->SetTitleOffset(2.5);
l->Draw("same");

c3->SaveAs("compare_reco_fake_corr_rmin.png");
c3->SaveAs("compare_reco_fake_corr_rmin.pdf");
...
//*******************************************************************************
//full correction
TH1D * h_reco_fakecorr_effcorr = new TH1D("h_reco_fakecorr_effcorr",";rmin;N_{evt}",nbins,low,high);
TH1D * h_reco_fakecorr_effcorr_unfold = new TH1D("h_reco_fakecorr_effcorr_unfold",";rmin;N_{evt}",nbins,low,high);
nt_track->Draw("rmin>>h_reco_fakecorr_effcorr","((1-fake)/eff)*(trackselect && pt>0.5)"); 
...
TLegend *leg4a = new TLegend(0.2,0.5,0.55,0.7);
...
h_genreco_fullcorr->GetXaxis()->SetTitleOffset(2.5);


l->Draw("same");
c4->SaveAs("compare_select_fullcorr_rmin.png");
c4->SaveAs("compare_select_fullcorr_rmin.pdf");
